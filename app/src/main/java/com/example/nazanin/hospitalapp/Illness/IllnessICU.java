...
public class IllnessICU extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn1 = v.findViewById(R.id.btn_tashanojICU);
        btn2 = v.findViewById(R.id.btn_Sepsis);
        btn3 = v.findViewById(R.id.btn_sekteGhalbiICU);
        btn4 = v.findViewById(R.id.btn_sekteMaghziICU);
        btn5 = v.findViewById(R.id.btn_masmumiatCOICU);
        btn6 = v.findViewById(R.id.btn_masmumiatICU);
