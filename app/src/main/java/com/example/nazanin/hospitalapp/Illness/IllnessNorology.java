...
public class IllnessNorology extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn1 = v.findViewById(R.id.btn_MS);
        btn2 = v.findViewById(R.id.btn_sekteMaghziNorology);
        btn3 = v.findViewById(R.id.btn_tashanojNorology);
        btn4 = v.findViewById(R.id.btn_gilen);
        btn5 = v.findViewById(R.id.btn_miasteni);
